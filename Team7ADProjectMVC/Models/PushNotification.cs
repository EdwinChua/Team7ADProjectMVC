...
namespace Team7ADProjectMVC.Models
{
    public class PushNotification
    {
        ...
        public void CollectionPointChanged(String deptid,String  collectionptid)
        {
                ...
                PushFCMNotificationToStoreClerk("Change of Collection Point", "Collection point changed to : "+ cpointName+" for "+deptname, myData);
        ...
        public void RepAcceptRequisition(String DisListID)
        {
            ...
            PushFCMNotificationToStoreClerk("Rep has accepeted", " for ", myData);
        }
